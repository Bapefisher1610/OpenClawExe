...
.PARAMETER Project
    Which project to build: All, Tray, WinUI, Shared, Cli, WinNodeCli, SetupEngine, Installer
    Default: All
...
param(
    [ValidateSet("All", "Tray", "WinUI", "Shared", "Cli", "WinNodeCli", "SetupEngine", "Installer")]
    [string]$Project = "All",
